        ...
        if ("GET".equals(h.getRequestMethod())) {
            if (hasAuth(h)) {
                ...
                if (data.containsKey(key)) {
                    ...
                    sendText(h, "Извините, у нас нет данного ключа", 405);
                }
            } else {
                sendText(h, "Пользователь не зарегистрирован", 405);
            }
        } else {
            sendText(h, "Мы ожидали от вас GET-запрос, а получили " + h.getRequestMethod(), 405);
        }
    }
